<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrozenFood.aspx.cs" Inherits="FrozenFood" %>
                ...
                <asp:Menu ID="NavigationMenu" runat="server" CssClass="menu" 
                    ...
                    <Items>
                        ...
                        <asp:MenuItem NavigateUrl="~/Products.aspx" Text="Products" Value="Products">
                            <asp:MenuItem Text="Fresh Fruit" Value="Fresh Fruit"></asp:MenuItem>
                            <asp:MenuItem Text="Bakery" Value="Bakery"></asp:MenuItem>
                            <asp:MenuItem Text="Frozen Food" Value="Frozen Food"></asp:MenuItem>
